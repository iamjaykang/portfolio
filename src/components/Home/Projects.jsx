  ...
  const projects = [
    {
      ...
      description:
        "A CRUD CRM Ticket Application built with the MERN stack, with features like dashboard, ticket query and the ability to add and update existing tickets. this app has been hosted on free tier Heroku service.",
      stacks: [
        "MongoDB",
        "Express",
        "React",
