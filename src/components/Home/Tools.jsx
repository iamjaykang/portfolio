    ...
    >
      <div className="p-4 mx-auto max-w-screen-xl lg:p-4">
        ...
        <div className="lg:ml-28">
          <p className="text-3xl my-8 text-black dark:text-gray-400">
        ...
        {tools &&
          tools.map((tool, i) => (
            <div className="flex flex-col lg:flex-row justify-around">
              <div>
                <h3 className="text-3xl mb-4 text-sky-600 font-bold dark:text-sky-700">
                  Back-End Technology
                </h3>
                <div>
                  {tool.backend &&
                    tool.backend.map((item) => (
                      <ul>
                        <li className="mb-4 font-bold text-xl dark:text-white">
                          {item}
                        </li>
                      </ul>
                    ))}
              ...
              <div>
                <h3 className="text-3xl mb-4 text-sky-600 dark:text-sky-700 font-bold">
                  Other
                </h3>
                <div>
                  {tool.other &&
                    tool.other.map((item) => (
                      <ul>
                        <li className="mb-4 text-xl font-bold dark:text-white">
                          {item}
                        </li>
                      </ul>
                    ))}
